class Text {
    ...
    show() {
        ...
        for (let d of this.dots) {
            ...
            //     d.show();
            // }
            if(d.target.dist(previousDot.target) < this.size/6 && d.pos.dist(previousDot.pos) < this.size/6){
                ...
                if(d.pos.dist(firstDot.pos) < this.size/1){
                    endShape(CLOSE);
                }else{
                    endShape();
                }
    ...
    pressedFunction() {
        for (let d of this.dots) {
            d.runFromTarget(this.force * 2, this.forceDist * 2, mouse);
